...
const settings = definePluginSettings({
    idleTimeout: {
        description: "Minuti prima che Discord passi allo stato inattivo (0 per disattivare l'inattività automatica)",
    ...
    remainInIdle: {
        description: "Quando torni su Discord, resta inattivo finché non confermi di voler tornare online",
...
export default definePlugin({
    name: "CustomIdle",
    description: "Consente di impostare il tempo prima che Discord passi allo stato inattivo oppure di disattivare l'inattività automatica",
    ...
    handleOnline() {
        ...
        showNotice(backOnlineMessage, "Termina stato inattivo", () => {
            popNotice();
            FluxDispatcher.dispatch({
                type: "IDLE",
                idle: false
