...
const settings = definePluginSettings({
    attemptToPreventCrashes: {
        ...
        description: "Prova a prevenire i crash di Discord.",
        default: true
    },
    attemptToNavigateToHome: {
        type: OptionType.BOOLEAN,
        description: "Prova a tornare alla Home quando viene evitato un crash di Discord.",
        default: false
    }
});
...
export default definePlugin({
    name: "CrashHandler",
    description: "Plugin di utilità per gestire e, quando possibile, recuperare dai crash senza riavvio",
    authors: [Devs.Nuckyz],
