...
export default definePlugin({
    name: "FriendInvites",
    description: "Crea e gestisce i link di invito amicizia tramite comandi slash (/create friend invite, /view friend invites, /revoke friend invites).",
    tags: ["Friends", "Commands"],
    authors: [Devs.afn, Devs.Dziurwa],
    commands: [
        {
            name: "create friend invite",
            description: "Genera un link di invito amicizia.",
        ...
        },
        {
            ...
            description: "Visualizza l'elenco di tutti gli inviti amicizia generati.",
            inputType: ApplicationCommandInputType.BUILT_IN,
            execute: async (_, ctx) => {
        ...
        },
        {
            ...
            description: "Revoca tutti gli inviti amicizia generati.",
            inputType: ApplicationCommandInputType.BUILT_IN,
            execute: async (_, ctx) => {
